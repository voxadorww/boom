// Spanish lessons dictionary - same structure as frontend
...
export function getLessonsByStage(stage: number) {
  ...
  return lessonsData[stageKey] || [];
}

export function getNextLesson(stage: number, completedLessons: string[]) {
  ...
  // If all lessons in this stage are completed, return null
  return null;
}
